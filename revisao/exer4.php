...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (($nivel_experiencia == 'junior' && $complexidade_tarefa != 'baixa') ||
              ($nivel_experiencia == 'pleno' && $complexidade_tarefa == 'alta')) {
        $pode_assumir = false;
        $mensagem = "O funcionário $nome_funcionario não pode assumir a tarefa $nome_tarefa devido à sua experiência.";
    }
